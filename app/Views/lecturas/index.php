<?= view('layouts/header', [
        'title'      => 'Lecturas registradas - Oficina del Agua',
    ...
    <div class="container-fluid py-4">
        ...
        <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                <h6 class="mb-0">Lecturas registradas</h6>
                <a href="<?= base_url('lecturas/pendientes') ?>" class="btn btn-outline-primary btn-sm mb-0">
                    Ver pendientes
                </a>
            </div>
                ...
                <div class="row g-2 align-items-end">
                    <div class="col-12 col-md-5">
                        ...
                        <input type="text" class="form-control form-control-sm" id="buscador"
                               placeholder="Contador, cliente o No. de recibo"
...
(function () {
    ...
    const urlBase    = '<?= base_url('lecturas/tabla') ?>';
    ...
    async function actualizar(pagina) {
        ...
        try {
            ...
            history.replaceState(null, '', '<?= base_url('lecturas') ?>?' +
